                        ...
                        <div className="card-body">
                            <form className="contact-us-form" onSubmit={(event) => this.sendMail(event)}>
                                ...
                                <div className="form-row">
                                    ...
                                    <div className="form-group col-md-6">
                                        <input type="tel" className="form-control" id="number" placeholder="Phone Number" required/>
                                        <small id="numberHelp" className="form-text text-muted invalid-text"></small>
                                    </div>
                                </div>
                                <div className="form-row">
                                    <div className="form-group col-md-12">
                                        <textarea className="form-control" id="question" rows = "3" placeholder = "Question" required></textarea>
